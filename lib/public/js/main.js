...
function addActiveClass() {
    ...
    $(".box-requests").append("<img src='default.gif'></img>");
    $(".box-idle-workers").append("<img src='default.gif'></img>");
    $(".box-requests-per-second").append("<img src='default.gif'></img>");
    $(".box-cpu").append("<img src='default.gif'></img>");
    $(".load-number1").append("<img src='default.gif'></img>");
    $(".load-number2").append("<img src='default.gif'></img>");
    $(".load-number3").append("<img src='default.gif'></img>");
    $(".box-size-per-req").append("<img src='default.gif'></img>");
    ...
    function loadJason() {
        $.getJSON(('http://localhost:4567/' + server), function(data) {
            $(".box-requests img").remove();
            $(".box-idle-workers img").remove();
            $(".box-requests-per-second img").remove();
            $(".box-cpu img").remove();
            $(".load-number1 img").remove();
            $(".load-number2 img").remove();
            $(".load-number3 img").remove();
            $(".box-size-per-req img").remove();
